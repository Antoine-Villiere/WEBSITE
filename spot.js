  ...
  function renderCard(el, d) {
    ...
    el.innerHTML = `
      <div class="bento-card">
        ...
        <div class="bento-warning">Attention : @${escapeHtml(d.username)} peut volontairement cacher ses statistiques, ce qui peut rendre erronés les chiffres ci-dessous.</div>
