...
.bento-collab-btn:hover { background:#005bb5; box-shadow:0 4px 8px rgba(0,0,0,0.2); }
.bento-collab-btn:active { transform:scale(0.95); }
.bento-collab-btn:focus { outline:none; box-shadow:0 0 0 3px rgba(0,123,255,0.5); }
  ...
  function renderCard(el, d) {
    ...
    el.innerHTML = `
      <div class="bento-card">
        ...
        <div class="bento-warning">Attention : @${escapeHtml(d.username)} peut volontairement cacher ses statistiques, ce peut rendre erronés les chiffres ci-dessous.</div>
