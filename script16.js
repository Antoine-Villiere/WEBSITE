        ...
        out.innerHTML = `
          <div class="bento-card">
            <div class="bento-header">
              <img src="${d.profile_pic_url}" crossorigin="anonymous" alt="${d.username}">
              <div class="header-text">
                <div class="name-block">
                  <div class="name">${d.full_name}</div>
                  <div class="username">@${d.username}</div>
                </div>
                <div class="bio-header">${d.biography || '—'}</div>
              </div>
            </div>
            ...
            <div class="bento-feed">
              ${d.recent_posts?.slice(0,6).map(url => `<img src="${url}" crossorigin="anonymous" alt="">`).join('')}
            </div>
          </div>
        `;
      } catch (err) {
