...
`;
  ...
  function renderCard(el, d) {
    ...
    el.innerHTML = `
      ...
      <div class="bento-warning"><strong>Attention :</strong> @${escapeHtml(d.username)} peut volontairement cacher ses statistiques, ce qui peut impacter les données ci-dessus.</div>      <div class="bento-feed">
